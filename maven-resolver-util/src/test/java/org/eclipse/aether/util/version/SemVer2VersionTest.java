...
/**
 */
public class SemVer2VersionTest extends AbstractVersionTest {

    protected Version newVersion(String version) {
        return new SemVer2Version(version);
    }
    ...
    void testTrimPadding() {
        // 1.0.0 -> 1
        List<SemVer2Version.Item> items = new ArrayList<>(Arrays.asList(
                new SemVer2Version.Item(SemVer2Version.Item.KIND_INT, 1),
                new SemVer2Version.Item(SemVer2Version.Item.KIND_INT, 0),
                new SemVer2Version.Item(SemVer2Version.Item.KIND_INT, 0)));
        assertEquals(3, items.size());
        SemVer2Version.trimPadding(items);
    ...
    void testTrimPaddingNotNeededString() {
        ...
        List<SemVer2Version.Item> items = new ArrayList<>(Arrays.asList(
                ...
                new SemVer2Version.Item(SemVer2Version.Item.KIND_INT, 0),
                new SemVer2Version.Item(SemVer2Version.Item.KIND_INT, 0),
                new SemVer2Version.Item(SemVer2Version.Item.KIND_PRE_RELEASE, "string")));
    ...
    void testTrimPaddingNeededQualifier() {
        ...
        List<SemVer2Version.Item> items = new ArrayList<>(Arrays.asList(
                ...
                new SemVer2Version.Item(SemVer2Version.Item.KIND_INT, 0),
                new SemVer2Version.Item(SemVer2Version.Item.KIND_INT, 0),
                new SemVer2Version.Item(SemVer2Version.Item.KIND_QUALIFIER, 0)));
        assertEquals(4, items.size());
        SemVer2Version.trimPadding(items);
        assertEquals(1, items.size());
    }
    ...
    void testEdgeCase_1_2() {
        // as expected
        assertOrder(X_GT_Y, "ga.ga.foo", "foo");
    }
    ...
    void testEdgeCase_2_1() {
        ...
        assertOrder(X_GT_Y, "1.0.0-ga-foo", "1-foo");
        assertOrder(X_EQ_Y, "1.0.0-ga-foo", "1-ga-foo");
        assertOrder(X_GT_Y, "1.0.0.final-foo", "1-foo");
