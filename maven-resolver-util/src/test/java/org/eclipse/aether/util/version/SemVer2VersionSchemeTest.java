...
/**
 */
public class SemVer2VersionSchemeTest {

    private SemVer2VersionScheme scheme;

    @BeforeEach
    void setUp() {
        scheme = new SemVer2VersionScheme();
    }
    ...
    void testEnumeratedVersions() throws InvalidVersionSpecificationException {
        ...
        assertTrue(c.containsVersion(new SemVer2Version("1.0")));
        ...
        assertTrue(c.containsVersion(new SemVer2Version("1.0")));
        assertTrue(c.containsVersion(new SemVer2Version("2.0")));
    ...
    private void assertContains(String msg, VersionConstraint c, boolean b, String... versions) {
        for (String v : versions) {
            assertEquals(b, c.containsVersion(new SemVer2Version(v)), String.format(msg, v));
        }
    }
    ...
    void testVersionCaching() throws InvalidVersionSpecificationException {
        ...
        SemVer2Version v1 = scheme.parseVersion("1.0.0");
        SemVer2Version v2 = scheme.parseVersion("1.0.0");
        ...
        SemVer2Version v3 = scheme.parseVersion("2.0.0");
        ...
        SemVer2Version v4 = scheme.parseVersion("1.0.0");
        assertSame(v1, v4, "Re-parsing the first version should still return the cached instance");

        // Test with various version formats
        SemVer2Version snapshot1 = scheme.parseVersion("1.0.0-SNAPSHOT");
        SemVer2Version snapshot2 = scheme.parseVersion("1.0.0-SNAPSHOT");
        ...
        SemVer2Version v5 = scheme.parseVersion("1.0");
        SemVer2Version v6 = scheme.parseVersion("1.0.0");
